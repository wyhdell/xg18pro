...
public class DegreeController extends HttpServlet {
    //    GET, http://49.234.227.112:8080/bysj1839_war_exploded/degree.ctl?id=1, 查询id=1的学位
    //    GET, http://49.234.227.112:8080/bysj1839_war_exploded/degree.ctl, 查询所有的学位
    //    POST, http://49.234.227.112:8080/bysj1839_war_exploded/degree.ctl, 增加学位
    //    PUT, http://49.234.227.112:8080/bysj1839_war_exploded/degree.ctl, 修改学位
    //    DELETE, http://49.234.227.112:8080/bysj1839_war_exploded/degree.ctl?id=1, 删除id=1的学位
    /**
     * 方法-功能
     * put 修改
     * post 添加
    ...
    /**
     * POST,http://49.234.227.112:8080/degree.ctl
    ...
    /**
     * DELETE, http://49.234.227.112:8080/degree.ctl?id=1
    ...
    /**
     * PUT, http://49.234.227.112:8080/degree.ctl
    ...
    /**
     * GET, http://49.234.227.112:8080/degree.ctl?id=1, 查询id=1的学位
     * GET, http://49.234.227.112:8080/degree.ctl, 查询所有的学位
     * 响应一个或所有学位对象
     * @param request
     * @param response
     * @throws ServletException
    ...
    private void responseDegrees(HttpServletResponse response)
        ...
        String degrees_json = JSON.toJSONString(degrees, SerializerFeature.DisableCircularReferenceDetect);//jason序列化
        //响应message到前端
