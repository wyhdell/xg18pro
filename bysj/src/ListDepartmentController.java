...
public class ListDepartmentController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            Collection<Department> departments = DepartmentService.getInstance().findAll();//找到后台刚添加的数据
            String degree_str = JSON.toJSONString(departments, SerializerFeature.DisableCircularReferenceDetect);
